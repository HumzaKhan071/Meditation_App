...
class PromoIcons extends StatelessWidget {
  ...
  const PromoIcons({Key? key, required this.assetName}) : super(key: key);
...
class Appbar extends StatelessWidget {
  ...
  const Appbar({Key? key, required this.swipeData}) : super(key: key);
...
class ModeBody extends StatelessWidget {
  const ModeBody({Key? key}) : super(key: key);
